...
function Edituser({el, ping, setping}) {
  ...
  return (
    <>
      <Button variant="primary" onClick={handleShow} className='editbutton'>
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Form.Control type="date" placeholder={el?.dateofbirth} onChange={(e)=>setedited({...edited, dateofbirth:e.target.value})}/>
      </Form.Group>
